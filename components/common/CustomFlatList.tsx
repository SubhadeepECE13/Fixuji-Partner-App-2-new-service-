import { useCustomFlatListHook } from "@/hooks/useCustomFlatList";
...
type CustomFlatListProps<T> = Omit<FlatListProps<T>, "ListHeaderComponent"> & {
  ...
  // {@link Props.HeaderComponent HeaderComponent}
  /**
   * An element that is above the list but lower than  and has the property sticky
   *
